...
More recently, I have been extending this agenda into **LLM-era compiler and system techniques**. On one side, I study LLMs and agents as new interfaces for compiler optimization, hardware-software co-design, and new-chip kernel development, including [EggMind](https://arxiv.org/abs/2604.17364) for LLM-guided equality-saturation strategy synthesis and agentic co-design workflows such as the next-generation APS and Spine. On the other side, I work on compiler and runtime systems for emerging ML workloads, including [IntelliC](https://github.com/uv-xiao/IntelliC), which studies inspectable compiler representations for human and agent collaboration; [PTO Runtime](https://github.com/hw-native-sys/simpler), which executes compiled task graphs for serving on Ascend chips and LingQu SuperPods; and [Hive](https://arxiv.org/abs/2604.17353), an inference infrastructure for multi-agent systems with programming-surface and control-layer support.
